#!/usr/bin/env bash
# Exercises the choreography saga end-to-end.
# Requires order-service (8081), payment-service (8082), inventory-service (8083), shipping-service (8084) running.
...
echo
echo "All choreography scenarios complete."
