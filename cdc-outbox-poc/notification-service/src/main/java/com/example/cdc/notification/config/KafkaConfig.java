package com.example.cdc.notification.config;
...
public class KafkaConfig {
    ...
    public DefaultKafkaConsumerFactory<String, OrderEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.cdc.notification.dto");
    ...
    /**
     * Retry with exponential backoff (1s, 2s, 4s, capped at 30s) for 5 attempts.
     * After exhaustion, the record is published to <originalTopic>.DLT and the
     * offset is committed so the consumer doesn't loop forever.
     */
    @Bean
